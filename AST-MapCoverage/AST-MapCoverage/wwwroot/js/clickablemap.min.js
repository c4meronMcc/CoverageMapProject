document.addEventListener('DOMContentLoaded', function () {
    ...
    const pinIconPath = 'path/to/pin-icon.png';
    ...
    function handleAreaClick(event) {
        if (!isDragging && !isMoving) {
            ...
            if (clickedElement.classList.contains('clicked')) {
                ...
                // Add pin icon
                const x = event.clientX - mapElement.getBoundingClientRect().left;
                const y = event.clientY - mapElement.getBoundingClientRect().top;
                addPinIcon(x, y);
            }
        }
        isMoving = false;
