document.addEventListener('DOMContentLoaded', function () {
    ...
    function handleAreaClick(event) {
        if (!isDragging && !isMoving) {
            ...
            const isSea = clickedElement.classList.contains('sea');
            const isOcean = clickedElement.classList.contains('ocean');
            ...
            if (isSea || isOcean) {
                ...
                if (clickedElement.classList.contains('clicked')) {
                    clickedElement.style.fill = isOcean ? '#B2BEB5' : '#6082B6';
                    ...
                    clickedElement.style.fill = 'green'; // Set the fill color to green
    ...
    function clearSelection() {
        if (selectedArea) {
            const isOcean = selectedArea.classList.contains('ocean');
            selectedArea.style.fill = isOcean ? '#B2BEB5' : '#6082B6';
        ...
        if (currentMapPinIcon) {
            ...
            currentMapPinIcon = null;
        }
    }

    function addmapPinIcon(x, y) {
        // Remove the previous pin icon if it exists
        ...
        const pinX = x - pinSize / 2 - mapBounds.left - window.pageXOffset;
        const pinY = y - pinSize - mapBounds.top - window.pageYOffset + 20;
        ...
        function updatePinPosition() {
            ...
            const pinX = x - pinSize / 2 - mapX;
            const pinY = y - pinSize - mapY + 20;
